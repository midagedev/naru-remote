...
- [x] T031 Update `docs/ROADMAP.md` (extend Phase 5 notes) + `PRODUCT_SPEC.md §6.2` to reflect shipped pointer modes / zoom-pan / screen-first viewport and compact live-session Dock behavior. **Done.**
