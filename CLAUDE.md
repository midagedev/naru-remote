...
- The active feature is pinned in `.specify/feature.json` (currently `specs/017-zoom-scoped-streaming`). `plan.md`, `research.md`, `data-model.md`, `tasks.md`, `contracts/`, and `quickstart.md` for that feature are authoritative — update them when implementation behavior changes.
