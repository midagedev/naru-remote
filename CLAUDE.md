...
- The active feature is pinned in `.specify/feature.json` (currently `specs/016-quiet-ops-visual-refinement`, round 2). `plan.md`, `research.md`, `data-model.md`, `tasks.md`, `contracts/`, and `quickstart.md` for that feature are authoritative — update them when implementation behavior changes.
