...
- The active feature is pinned in `.specify/feature.json` (currently `specs/042-vnc-first-helper-optional`). `plan.md`, `research.md`, `data-model.md`, `tasks.md`, `contracts/`, and `quickstart.md` for that feature are authoritative — update them when implementation behavior changes.
