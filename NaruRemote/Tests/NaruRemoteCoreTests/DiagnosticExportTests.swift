...
final class DiagnosticExportTests: XCTestCase {
    ...
    func testRenderCollectionJSONIsDeterministicCurrentSchema() throws {
        ...
        XCTAssertTrue(rendered.contains("\"schemaVersion\" : 36"))
        ...
        XCTAssertEqual(decoded.schemaVersion, 36)
    ...
    func testRenderSharePayloadIncludesPlainTextAndCollectionJSON() throws {
        ...
        XCTAssertTrue(payload.contains("--- Naru Remote Diagnostic JSON v36 ---"))
        XCTAssertTrue(payload.contains("\"schemaVersion\" : 36"))
